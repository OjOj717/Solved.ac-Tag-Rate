...
function getTierInfo(rating) {
    ...
    if (rating >= 150) return { color: "#ad5600", id: 5 }; // Bronze 1
        ...
        const listItems = topTags.map((t, i) => {
            ...
            return `
                <g transform="translate(0, ${y})">
                    ...
                    <text x="${width - 82}" y="23" fill="#fff" font-family="sans-serif" font-size="12" font-weight="bold" text-anchor="end">${tierNumber}</text>
