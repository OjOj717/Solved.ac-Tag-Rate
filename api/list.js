...
function getTierInfo(rating) {
    if (rating >= 3000) return { color: "#b491ff", id: 31 };
    if (rating >= 2950) return { color: "#ff0062", id: 30 };
    ...
    if (rating >= 2600) return { color: "#00b4fc", id: 25 };
    ...
    if (rating >= 2100) return { color: "#27e2a4", id: 20 };
    ...
    if (rating >= 1400) return { color: "#ec9a00", id: 15 };
    ...
    if (rating >= 650) return { color: "#435f7a", id: 10 };
    ...
    if (rating >= 150) return { color: "#ad5600", id: 5 };
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const themes = {
            light: { cardBg: "#f7f8f9", line: "#afb8c2", text: "#333333", subText: "#666666" },
            dark: { cardBg: "#24283b", line: "#444b6a", text: "#a9b1d6", subText: "#787c99" },
            paper: { cardBg: "#fdf6e3", line: "#93a1a1", text: "#586e75", subText: "#839496" }
        };
        ...
        const listItems = topTags.map((t, i) => {
            ...
            return `
                <g transform="translate(0, ${y})">
                    ...
                    <image xlink:href="https://static.solved.ac/tier_small/${tier.id}.svg" x="${width - 98}" y="8" width="20" height="20" />
        ...
        <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <text x="${padding + 50}" y="40" fill="${sel.subText}" font-family="sans-serif" font-size="12" font-weight="bold" text-anchor="middle">${labels.tag}</text>
            ...
            <text x="${width - 55}" y="40" fill="${sel.subText}" font-family="sans-serif" font-size="12" font-weight="bold" text-anchor="middle">${labels.rating}</text>
